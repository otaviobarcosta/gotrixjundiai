/* ============================================
   GOTRIX JUNDIAÍ - CATÁLOGO DE PRODUTOS
   Dados puxados do catálogo oficial Gotrix.
   Para trocar foto: substitua o campo "img".
   ============================================ */
...
const PRODUTOS = [
  ...
  {
    id: "bike-v8-pro-s",
    nome: "Bike V8 Pro-S (2 baterias)",
    categoria: "Bike",
    tag: "100 KM DE AUTONOMIA",
  ...
  // ---------- TRICICLOS E PATINETE ----------
  {
    id: "triciclo-a3t",
    nome: "Triciclo Elétrico A3T",
    categoria: "Triciclo",
    tag: "COM BAÚ",
